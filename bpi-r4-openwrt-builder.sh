...
git clone --branch main https://github.com/brudalevante/openwrt-sin-mlo.git openwrt || true
cd openwrt; git checkout 7ebc59c8123abe71e503673c200bf41eaabc5e36; cd -;
